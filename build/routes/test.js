...
router.get("/", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var filename, width, height, parameter, resizedImage, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                else if (parameter.width <= 0 || typeof parameter.width !== "number") {
                    throw new Error("Invalid width value for ".concat(parameter.width));
                }
                else if (parameter.height <= 0 || typeof parameter.height !== "number") {
