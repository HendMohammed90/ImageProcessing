...
describe("Testing the main endpoint", function () {
    ...
    it("Using the endpoint without providing the parameters Throw New Error", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request.get("/").expect(404)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it("Using the endpoint with a non-existent Image name  Throw New Error", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
